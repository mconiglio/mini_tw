...
class UserTest < ActiveSupport::TestCase
	...
	def setup
		@user = User.new(name: "Example User", username: "sampleuser", email: "user@valid.com",
  ...
  test "username validation should accept valid usernames" do
    valid_usernames = %w[my.name67 my_name67 myname67 my_name M_ynAme my.name]
  ...
  test "username validation should reject invalid usernames" do
    invalid_usernames = %w[__myname .myname 94myname]
